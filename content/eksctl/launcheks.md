...
Run `aws sts get-caller-identity` and validate that your _Arn_ contains `eksworkshop-admin-yourusername` or `TeamRole`
...
```
eksctl create cluster --name=eksworkshop-eksctl-yourusername --nodes=3 --alb-ingress-access --region=${AWS_REGION}
```
